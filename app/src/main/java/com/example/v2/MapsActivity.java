...
//        listSurya = getIntent().getIntExtra("riskscoreSurya", 0);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        akul = mMap.addMarker(new MarkerOptions().position(Akul).title("Akul").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
